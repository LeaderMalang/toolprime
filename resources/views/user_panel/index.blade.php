@extends('user_panel.layout.master')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                    ...
                                    <input class="input100 form-control" required type="password" name="current-password" value="{{old('current-password')}}" placeholder="Current Password" autocomplete="current-password">
                                </div>
                                @if ($errors->has('current-password'))
                                                    <span class="text-danger text-left">{{ $errors->first('current-password') }}</span>
                                                @endif
                            </div>
                            <div class="form-group">
                                ...
                                <div class="wrap-input100 validate-input input-group" id="Password-toggle1">
                                    ...
                                    <input class="input100 form-control" required type="password" value="{{old('password')}}" name="password" placeholder="New Password" autocomplete="new-password">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="wrap-input100 validate-input input-group" id="Password-toggle2">
                                    ...
                                    <input class="input100 form-control" required type="password" value="{{old('password_confirmation')}}" name="password_confirmation" placeholder="Confirm Password" autocomplete="new-password">
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                    ...
                                    <input class="input100 form-control" type="file" name="image" autocomplete="current-password">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="" id="exampleInputname" placeholder="Full Name">
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group mg-b-10">
                                        ...
                                        <span class="custom-switch-description mg-l-10">Tow Setup Verification </span>
                                    </label>
                                    </div>
                                    <div class="form-group mg-b-10">
                                        <label class="custom-switch ps-0">
                                        ...
                                        <span class="custom-switch-indicator me-3"></span>
                                        <span class="custom-switch-description mg-l-10">Send Eamil Notifications </span>
                                    </label>
                                    </div>
                                    <div class="form-group mg-b-10">
                                        <label class="custom-switch ps-0">
                                    ...
                                    <div class="form-group mg-b-10">
                                        ...
                                        <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input">
                                        <span class="custom-switch-indicator me-3"></span>
                                        <span class="custom-switch-description mg-l-10">Always Sign</span>
                                    </label>
                                    </div>
                                    {{-- <div class="form-group mg-b-10">
                                        <label class="custom-switch ps-0">
                                    ...
                                    <ul class="task-list">
                                        <li class="d-sm-flex">
                                            <div>
                                                ...
                                                <h6 class="fw-semibold">Account Status<span class="text-muted fs-11 mx-2 fw-normal">09 July 2021</span>
                                                </h6>
                                        ...
                                        <li class="d-sm-flex">
                                            <div>
                                                <i class="task-icon bg-primary"></i>
                                                <h6 class="fw-semibold">Account Type<span class="text-muted fs-11 mx-2 fw-normal">09 July 2021</span>
                                                </h6>
                                                <p class="text-muted fs-12">Adam Berry finished task on<a href="javascript:void(0)" class="fw-semibold"> Project Management</a></p>
                                            </div>
                                        ...
                                        <li class="d-sm-flex">
                                            <div>
                                                <i class="task-icon bg-primary"></i>
                                                <h6 class="fw-semibold">Api Key<span class="text-muted fs-11 mx-2 fw-normal">09 July 2021</span>
                                                </h6>
                                                <p class="text-muted fs-12">Adam Berry finished task on<a href="javascript:void(0)" class="fw-semibold"> Project Management</a></p>
                                            </div>
