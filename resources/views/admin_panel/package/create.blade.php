                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{route('packeges.store')}}" method="POST"  enctype="multipart/form-data">
                                            ...
                                            <div class=" row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" class="form-control" value="{{old('price')}}" name="price" id="slug" placeholder="Price" autocomplete="userslugname">
                                                </div>
                                                @if ($errors->has('price'))
                                            ...
                                            <div class=" row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea type="text" class="form-control" value="" name="des" >
                                                        {{old('des')}}
                                                    </textarea>
                                                </div>
                                                @if ($errors->has('des'))
