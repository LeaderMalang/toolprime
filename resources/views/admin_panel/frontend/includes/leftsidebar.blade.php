...
<div class="sticky">
    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{route('admin-home-page')}}">
                <h3>Tool Prime</h3>
            </a>
            <!-- LOGO -->
        </div>
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('permissions.index')}}"><i
                            class="side-menu__icon fe fe-user"></i><span class="side-menu__label">Permissions</span></a>
                </li>
                <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                            ...
                            class="side-menu__label">E-Commerce</span><i class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
